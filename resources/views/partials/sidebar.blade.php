<div id="sidebar" class="bg-light text-white vh-100 p-2">
    <div class="logo_container text-center d-flex align-items-center justify-content-center py-3">
        <img src="{{ asset('assets/img/leiaai_logo.png') }}" alt="Logo" class="img-fluid mb-2" style="max-height: 60px;">
    ...
    <nav class="nav flex-column">
        ...
        <a href="{{ route('class.index') }}" class="nav-link text-dark mb-2"><i class="fa-solid fa-users me-2"></i> Classes</a>
        ...
        <a href="#" class="nav-link text-dark mb-2"><i class="fa-solid fa-chart-line"></i> Progress</a>
    </nav>
</div>
